...
model_l1px.save('model_l1px.h5')
model_l1py.save('model_l1py.h5')
model_l1pz.save('model_l1pz.h5')
model_l1vx.save('model_l1vx.h5')
model_l1vy.save('model_l1vy.h5')
model_l1vz.save('model_l1vz.h5')
model_l2px.save('model_l2px.h5')
model_l2py.save('model_l2py.h5')
model_l2pz.save('model_l2pz.h5')
model_l2vx.save('model_l2vx.h5')
model_l2vy.save('model_l2vy.h5')
model_l2vz.save('model_l2vz.h5')
model_l3px.save('model_l3px.h5')
model_l3py.save('model_l3py.h5')
model_l3pz.save('model_l3pz.h5')
model_l3vx.save('model_l3vx.h5')
model_l3vy.save('model_l3vy.h5')
model_l3vz.save('model_l3vz.h5')
